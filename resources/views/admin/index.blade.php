                                        ...
                                        <table class="table text-nowrap align-middle table-custom mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="ps-0">
                                                        <div class="d-flex align-items-center gap-6">
                                                            <img src="/admin/assets/images/products/dash-prd-1.jpg"
                                                ...
                                                <tr>
                                                    <td class="ps-0">
                                                        <div class="d-flex align-items-center gap-6">
                                                            <img src="/admin/assets/images/products/dash-prd-2.jpg"
                                                                alt="prd1" width="48" class="rounded" />
                                                            <div>
                                                ...
                                                <tr>
                                                    <td class="ps-0">
                                                        <div class="d-flex align-items-center gap-6">
                                                            <img src="/admin/assets/images/products/dash-prd-3.jpg"
                                                                alt="prd1" width="48" class="rounded" />
                                                            <div>
                                                ...
                                                <tr>
                                                    <td class="ps-0">
                                                        <div class="d-flex align-items-center gap-6">
                                                            <img src="/admin/assets/images/products/dash-prd-4.jpg"
                                                                alt="prd1" width="48" class="rounded" />
                                                            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card overflow-hidden hover-img">
                                <div class="position-relative">
                                    <a href="javascript:void(0)">
                                        <img src="/admin/assets/images/blog/blog-img1.jpg" class="card-img-top"
                                            alt="matdash-img">
                                    </a>
                                    <span
                        ...
                        <div class="col-lg-4">
                            <div class="card overflow-hidden hover-img">
                                <div class="position-relative">
                                    <a href="javascript:void(0)">
                                        <img src="/admin/assets/images/blog/blog-img2.jpg" class="card-img-top"
                                            alt="matdash-img">
                                    </a>
                                    <span
                                        class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary"
                                        href="">Intel loses bid to revive
                                        antitrust case
                        ...
                        <div class="col-lg-4">
                            <div class="card overflow-hidden hover-img">
                                <div class="position-relative">
                                    <a href="javascript:void(0)">
                                        <img src="/admin/assets/images/blog/blog-img3.jpg" class="card-img-top"
                                            alt="matdash-img">
                                    </a>
                                    <span
                                        class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary"
                                        href="">COVID outbreak deepens as more
                                        lockdowns
                                        loom in China</a>
                                    <div class="d-flex align-items-center gap-4">
                                        <div class="d-flex align-items-center gap-2">
